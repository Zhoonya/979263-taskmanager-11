...
export default class BoardController {
  ...
  _renderLoadMoreButton() {
    ...
    this._loadMoreButtonComponent.setClickHandler(() => {
      ...
      const newTasks = renderTasks(taskListElement, sortedTasks, this._onViewChange);

      this._showedTaskControllers = this._showedTaskControllers.concat(newTasks, this._onDataChange);
